...
from utilities.path_utilities import get_parent_directory, create_directory
from utilities.file_search import find_files_in_folder

def graph_folder_of_files(data_folder_path: Path):
    ...
    file_type = ".dat" #change this to match file extension if it ever changes to ".csv" or ".tsv"
    ...
    for file in file_list:
        ...
        file_name = file.split(".dat")[0] #change this to match file extension if it ever changes to ".csv" or ".tsv"
...
if __name__ == "__main__":
    example_path = Path("/Users/philipqueen/Documents/Highline/TaglineBreaktests/test_dats")
